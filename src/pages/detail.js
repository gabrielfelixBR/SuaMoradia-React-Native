        ...
        <View style={{width: '35%'}}>
          ...
          <View style={{alignItems: 'center', flexDirection: 'row'}}>
            <Stars
              ...
              half={true}
              starSize={20}
              fullStar={<AntDesign name="star" size={24} style={styles.myStarStyle}/>}
              emptyStar={<AntDesign name='staro' size={24} style={styles.myStarStyle}/>}
              halfStar={<FontAwesome name='star-half' size={24} style={styles.myStarStyle}/>}
            />
          </View>
        </View>
      </View>
